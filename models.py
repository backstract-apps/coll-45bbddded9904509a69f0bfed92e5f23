...
class Students(Base):
    ...
    date_of_birth = Column(Date, primary_key=False )
...
class Classes(Base):
    ...
    subject_id = Column(Integer, primary_key=False )
    teacher_id = Column(Integer, primary_key=False )
...
class Enrollments(Base):
    ...
    class_id = Column(Integer, primary_key=False )
...
class Grades(Base):
    ...
    student_id = Column(Integer, primary_key=False )
    class_id = Column(Integer, primary_key=False )
    grade = Column(Float, primary_key=False )
