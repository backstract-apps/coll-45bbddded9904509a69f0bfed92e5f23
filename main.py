...
app = FastAPI(title='Backstract Generated APIs - coll-45bbddded9904509a69f0bfed92e5f23', debug=False,
              docs_url='/great-matsumoto-412522726c6a11f0bf077aedc756acff71/docs',
              openapi_url='/great-matsumoto-412522726c6a11f0bf077aedc756acff71/openapi.json')
...
app.include_router(
    router,
    prefix='/great-matsumoto-412522726c6a11f0bf077aedc756acff71/api',
    tags=['APIs v1']
)
